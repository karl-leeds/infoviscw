...
def ukCountries(values):
    ...
    map_df = gpd.read_file("geo_files/GBR_adm1.shp")
...
def usStates(values):
    ...
    for idx, row in map_df.iterrows():
        plt.annotate(s=row['NAME_1'], xy=row['coords'], horizontalalignment='center', fontsize=100, arrowprops=dict(visible="True"))
